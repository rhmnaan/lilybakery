                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-[#FFF7F3] divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <?php    $__currentLoopData = $produkTerlaris;
$__env->addLoop($__currentLoopData);
        foreach ($__currentLoopData as $produk):
            $__env->incrementLoopIndices();
            $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <?php        echo e($produk->nama_produk); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Rp
                                        <?php        echo e(number_format($produk->harga, 0, ',', '.')); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                        <?php        echo e($produk->total_terjual); ?></td>

                                    <?php
            // Menghitung total pendapatan per produk
            $pendapatanPerProduk = $produk->harga * $produk->total_terjual;
                ?>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Rp
                                        <?php        echo e(number_format($pendapatanPerProduk, 0, ',', '.')); ?></td>
                                </tr>
                                <?php    endforeach;
        $__env->popLoop();
        $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">Belum ada data penjualan
                                        produk.</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
