...
<body class="antialiased bg-white">
    ...
    <main class="pt-20">
        <!-- Hero Section -->
        <section class="py-16 relative overflow-hidden h-auto md:h-[900px] overflow-hidden" style="background: linear-gradient(90deg, rgb(255, 235, 239) 10%, rgb(241, 61, 104) 300%);">
            ...
            <div class="w-full max-w-[1440px] mx-auto px-4 md:px-8 relative z-20">
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div class="md:w-1/2 mb-8 md:mb-0 pt-1">
                        ...
                        <h1 class="text-4xl md:text-7xl font-semibold mb-6">Manisnya <span class="text-lily-pink-dark">Setiap</span> <br>Gigitan</h1>
       ...
       <section class="py-16 relative overflow-hidden md:h-[650px]" style="background-color: #EFECEA;">
            <!-- Dekorasi kiri atas -->
            <img src="/images/elemenrecom1.png" alt="Dekorasi Kiri Atas" class="absolute top-0 left-0 w-32 md:w-40 opacity-70 z-0">

            <!-- Dekorasi kanan bawah -->
            <img src="/images/elemenrecom2.png" alt="Dekorasi Kanan Bawah" class="absolute bottom-0 right-0 w-36 md:w-56 opacity-70 z-0 transform rotate-90">
           ...
           <div class="container mx-auto px-4 md:px-0 relative z-10">
                <div class="flex flex-col md:flex-row md:items-start items-center gap-8 md:gap-12">
                    ...
                    <!-- Container untuk cards dan tombol panah -->
                     <div class="w-full md:w-2/3 relative md:ml-10">
                        <!-- Container cards yang scrollable secara horizontal -->
                        <div id="cakes-container" class="flex gap-6 overflow-x-auto scroll-smooth cursor-grab pr-4 md:pr-10">
                            <!-- Cake 1 -->
                            <div class="bg-white rounded-lg overflow-hidden shadow-md w-[300px] h-[450px] flex-shrink-0">
                                <img src="/images/previewcake.png" alt="Lychee Rose Cake" class="w-full h-50 object-cover p-4">
                                <div class="p-4 pt-1">
                                    <h3 class="font-questrial text-[16px] font-normal mb-1">Cosette's Garden</h3>
                                    <div class="flex space-x-2 items-baseline mb-1">
                                        <p class="font-questrial text-[16px] font-normal mb-0">From</p>
                                        <p class="font-questrial text-[19.05px] font-normal">Rp 300.000</p>
                                    </div>
                                    <div class="flex mb-4">
                            ...
                            <div class="bg-white rounded-lg overflow-hidden shadow-md w-[300px] h-[450px] flex-shrink-0">
                                <img src="/images/previewcake.png" alt="Lychee Rose Cake" class="w-full h-50 object-cover p-4">
                                <div class="p-4 pt-1">
                                    <h3 class="font-questrial text-[16px] font-normal mb-1">Popcorn Caramello</h3>
                                    <div class="flex space-x-2 items-baseline mb-1">
                                        <p class="font-questrial text-[16px] font-normal mb-0">From</p>
                                        <p class="font-questrial text-[19.05px] font-normal">Rp 300.000</p>
                                    </div>
                            ...
                            <!-- Bisa tambah card lagi di sini jika mau -->
                        ...
                        <!-- Tombol panah kanan -->
                        <!-- Tombol panah kanan: hanya muncul di desktop -->
                        <button id="scroll-right"
                            class="hidden md:block absolute top-1/2 right-[-10px] bg-transparent p-3 rounded-full transform -translate-y-1/2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="50" viewBox="0 0 24 24" fill="none" stroke="#D6A4B8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                <circle cx="12" cy="12" r="10"/>
                                <polyline points="10 8 14 12 10 16"/>
                            </svg>
                        </button>

                        <!-- Tombol panah di bawah: hanya muncul di mobile -->
                        <div class="flex justify-center mt-4 md:hidden">
                            <button id="scroll-right-mobile" class="bg-transparent p-3 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#D6A4B8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                    <circle cx="12" cy="12" r="10"/>
                                    <polyline points="10 8 14 12 10 16"/>
                                </svg>
                            </button>
    ...
    <section class="py-16 bg-gray-200">
        <div class="max-w-[95%] mx-auto px-4 text-center">
            ...
            <button class="bg-[#5E5C70] text-white px-6 py-2 rounded-md hover:bg-gray-800 transition duration-300 mb-12">
                Lihat Selengkapnya
            </button>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg max-w-[90%] mx-auto min-h-[500px]">
                    ...
                    <p class="text-gray-600 text-left px-4 pb-4">
                        Menyajikan kelembutan klasik buttercream dengan sentuhan modern yang akan memuaskan imajinasi! Cocok bagi Anda yang menginginkan tampilan kue yang lebih alami, lembut, namun tetap estetik.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg max-w-[90%] mx-auto min-h-[500px]">
                    <div class="bg-yellow-100 rounded-t-lg h-64 mb-4 overflow-hidden">
                        <img src="/images/customlettering.png" alt="Kustom Tulisan" class="w-full h-full object-cover">
                    </div>
                    <h3 class="text-[#5E5C70] text-3xl font-bold mb-3 text-left px-4">Kustom Tulisan</h3>
                    <p class="text-gray-600 text-left px-4 pb-4">
                        Tambahkan sentuhan personal pada kue dengan tulisan tangan indah. Bisa berupa nama, ucapan selamat, atau kutipan favorit Anda dengan gaya huruf dan warna teks bervariasi. Membuat kue yang terasa lebih bermakna dan berkesan.
                    </p>
                </div>
            </div>
        </div>
