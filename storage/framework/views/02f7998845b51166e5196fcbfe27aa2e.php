    ...
    <div class="container ml-12 px-4 flex items-center justify-between">
            ...
            <nav class="hidden md:flex ml-20 space-x-8 pt-3 font-bold">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg overflow-hidden z-50 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-200 origin-top-left">
                        <div class="py-2">
                            <!-- Dropdown items -->
                            <a href="<?php echo e(url('/menu/bread')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-50">
                            ...
                            <a href="<?php echo e(url('/menu/cake')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-50">
                                <img src="/images/menu/cake.jpg" alt="Cake" class="w-10 h-10 rounded-full object-cover">
                                <span class="ml-3 text-gray-700">Cake</span>
                            </a>
                            
                            <a href="<?php echo e(url('/custome-cake')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-50">
                            ...
                            <a href="<?php echo e(url('/menu/cookies')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-50">
                            ...
                            <a href="<?php echo e(url('/menu/donat')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-50">
                            ...
                            <a href="<?php echo e(url('/menu/macaroon')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-50">
                ...
                <a href="<?php echo e(url('/promotion')); ?>" class="text-[#707070] hover:text-lily-pink-dark">PROMOTION</a>
                <a href="<?php echo e(url('/stores')); ?>" class="text-[#707070] hover:text-lily-pink-dark">STORES</a>
                <a href="<?php echo e(url('/about-us')); ?>" class="text-[#707070] hover:text-lily-pink-dark">ABOUT US</a>
            </nav>
        </div>
        ...
        <div class="flex flex-col items-center mt-2 mr-10">
            <div class="flex items-center space-x-4 mr-5">
                <a href="<?php echo e(url('/cart')); ?>" class="bg-[#EDF3F7] px-5 py-2 rounded-full text-[#707070] hover:bg-lily-pink transition duration-300 font-bold">
                    CART <i class="fas fa-shopping-cart ml-1"></i>
                </a>
                
                <?php if(auth()->guard()->check()): ?>
                    <!-- Logged in user display -->
                    <a href="<?php echo e(url('/profile')); ?>" class="bg-lily-pink text-white px-5 py-2 rounded-full hover:bg-lily-pink-dark transition duration-300 font-bold flex items-center">
                        <span><?php echo e(Auth::user()->name); ?></span>
                        <i class="fas fa-user-circle ml-2 text-lg"></i>
                    </a>
                <?php else: ?>
                    <!-- Login/Sign up button for guests -->
                    <a id="login-btn" href="<?php echo e(url('/login')); ?>" class="bg-lily-pink-dark text-white px-10 py-2 rounded-full hover:bg-lily-pink transition duration-300 font-bold">
                        LOGIN/SIGN UP
                    </a>
                <?php endif; ?>
            </div>
...
</script><?php /**PATH C:\laragon\www\lilybakery\resources\views/layouts/header.blade.php ENDPATH**/ ?>